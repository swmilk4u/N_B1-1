...
### 예시 3: 안전장치 적용 (근거 부족 항목에 대해 '확인 필요' 명시)
**입력:**
```
...
> * **적용**: 이러한 실제 검증 사례를 기반으로, 가이드북 생성 도중 확실하지 않은 외부 제약 규정이 요구될 시 AI가 억측을 배제하고 **`확인 필요 (근거 부족)`** 영역으로 별도 분류하여 출력하도록 시스템 규칙(Few-shot 예시 3)을 정형화했습니다.�, 친절한 톤, 단계적 안내, 전문용어 최소화
